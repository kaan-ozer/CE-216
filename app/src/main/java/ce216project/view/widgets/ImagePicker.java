...
public class ImagePicker extends VBox {
    ...
    private void getCoverImage() {
        ...
        String imagesFolderPath = System.getProperty("user.dir") + File.separator + "shared" + File.separator
                + "images";
        ...
        if (fullPath.startsWith(System.getProperty("user.dir").trim().split("app")[0])) {
            ...
            alert.setContentText(
                    "Selected photo must be inside of the project under images or anywhere in app folder!");
            alert.showAndWait();
        }
    }
